...
<div class="slider-a" id="slider">
						<div class="slItems">
							<div class="slText">
								
								<h1 class="slider-txt"><span style="color: #272727;">ABOUT</span> US </h1>
		...
		<!-- =================================================== -->
		<!-- CONTENT -->
		<div id="title" style="background-image: url(images/om-bob.jpg);" class="slide-section header parallax-window" data-parallax="scroll">
			  ...
			  <div class="container">
				  	<div class="row box">
						...
						<div class="col-md-4">
					  	...
					  	<div class="col-md-4">
					  		<div class="box-radius news-panel pull-left" style=" text-align: left; color: #000;">
						  		<h1 class="bold-txt">#OZ_NEWS</h1>
						  	</div>
					  	</div>

					  	<div class="col-md-4">
					  		<div class="box-radius news-panel pull-right" style="float: left; text-align: right;">
						  		<h1>OZ DISCOLAND</h1>
					  	...
					  	<div class="col-md-4">
					  		<div class="box-radius news-panel pull-right" style="float: left; margin-left: 10%;">
