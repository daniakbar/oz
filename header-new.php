<?php include 'header.php'; ?>
		...
		<!-- =================================================== -->
		<!-- CONTENT -->
		<div id="title" style="background-image: url(images/maxres.jpg);" class="slide-section header para llax-window" >
		...
		<div id="tit le" style="background-image: url(images/maxres.jpg);" class="slide-section">
		...
		<div id="sli de5-section" class="slide-client header-section">
			<div class="container">
